...
<div class="large-12 columns">
		...
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#4586FF;">2</a>
	...
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<p><b>Your Reservation</b></p><hr class="line">
				...
				<div class="row">
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<br><button name="submit" href="#" class="btn btn-primary btn-learn" style="" >Edit Reservation</button>
					</div>
				  </div>
				</form>
		</div>
		<div class="large-12 columns" id="roomselected" style="display:none;" >
				<hr>
							<br><label for="submit-form" class="book button small fontslabo" style="background-color:#4586FF; width:100%; height:45px; !important;">Proceed To Book</label><!--button name="submit" href="#" class="button small fontslabo" style="background-color:#4586FF; width:100%;" >Proceed Booking</button-->
					...
					while ($row = mysql_fetch_array($result)) {
						...
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysql_num_rows($sub_result2) > 0)
							{
								...
								//print "				<button type=\"submit\"  class=\"book button small\" style=\"background-color:#4586FF; width:100%; height:45px; !important;\" >Book</button>\n";	
								print "								</div>\n";
								print "							</div>\n";
								print "						</div>\n";
								print "						\n";
