...
<div class="large-12 columns">
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round blackblur font" style="background-color:#4586FF;">1</a>
		</div>
		<div class="large-3 columns centerdiv">
...
<div class="row">
	...
	<p><b>Check Date</b></p><hr>
			...
			<br><br>
			  <div class="row">
				<div class="large-12 columns" >
					<button type="submit" href="#" class="button small" style="background-color:#4586FF;" >Check Availability</button>
				</div>
			  </div>
			</form>
	</div>
